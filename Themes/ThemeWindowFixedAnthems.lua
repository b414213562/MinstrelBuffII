ThemeWindowFixedAnthems = class();

ThemePath2 = ThemesPath .. "2 Window Fixed Anthems/";

function ThemeWindowFixedAnthems:Constructor()
	self.name = "Window - Fixed anthems"; -- Name of the theme

	-- The whole window.
	self.windowBackground = ThemePath2 .. "minstrel_buffbar_background_fixed.tga"; -- The background for the window. Use it, when you have a combined picture of ballads and anthems. Can be nil for no image.
	self.windowWidth = 198; -- The size of the window.
	self.windowHeight = 111; -- The size of the window.
