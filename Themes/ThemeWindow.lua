...
ThemePath1 = ThemesPath .. "1 Window/";

function ThemeWindow:Constructor()
	self.name = "Window - Standard"; -- Name of the theme
	
	-- The whole window.
	self.windowBackground = ThemePath1 .. "minstrel_buffbar_background_anthems_3.tga"; -- The background for the window. Use it, when you have a combined picture of ballads and anthems. Can be nil for no image.
	...
	self.windowBackgrounds[3] = self.windowBackground;
	self.windowBackgrounds[4] = ThemePath1 .. "minstrel_buffbar_background_anthems_4.tga";
	self.windowBackgrounds[5] = ThemePath1 .. "minstrel_buffbar_background_anthems_5.tga";
	self.windowBackgrounds[6] = ThemePath1 .. "minstrel_buffbar_background_anthems_6.tga";
