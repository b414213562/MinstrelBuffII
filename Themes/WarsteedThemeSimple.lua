...
WarsteedThemeSimple = class();

WarsteedThemePath1 = ThemesPath .. "W1 Warsteed Simple/";

function WarsteedThemeSimple:Constructor()
	self.name = "Simple theme for warsteeds"; -- Name of the theme
	...
	self.anthemBackground = WarsteedThemePath1 .. "mb_ws_anthem_background.tga"; -- The background for the anthem area. Can be nil for no image.
